...
function display_info_card() {
	?>
	<input type="checkbox" name="am_infobox_card" value="1" <?php echo (get_option('am_infobox_card') == '1' ? 'checked' : '')?>>
	<?php
}
...
function infobox_settings() {
	...
	add_settings_field("am_infobox_card", "Display infobox as static card", "display_info_card", "infobox-options", "amenities_settings");

	register_setting("amenities_settings", "am_infobox_card");
